...
void edition_rectangle_in_table(shape_struct_t *shape) {
    ...
    printf("Votre nouveau rectangle aura son premier point aux coordonnées : x = %d / y = %d,"
...
void edition_line_in_table(shape_struct_t *shape) {
    ...
    printf("Votre nouvelle ligne aura son premier point aux coordonnées : x = %d / y = %d,"
